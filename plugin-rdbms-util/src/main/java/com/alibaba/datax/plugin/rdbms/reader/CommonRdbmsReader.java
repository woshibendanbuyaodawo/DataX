...
import com.alibaba.datax.plugin.rdbms.util.PrometheusMeterRegistryManager;
...
public class CommonRdbmsReader {
  ...
  public static class Task {
    ...
    public void startRead(
      ...
      ResultSet rs = null;
      try {
        EntityMeters entityMeters = PrometheusMeterRegistryManager.meters(table);
        ...
        entityMeters.addTaskTotalTime(System.currentTimeMillis() - start);
    ...
    protected Record transportOneRecord(
      ...
      Record record =
          buildRecord(
              ...
              taskPluginCollector,
              entityMeters);
      entityMeters.addBuildRecordTime(System.currentTimeMillis() - start);
    ...
    protected Record buildRecord(
      ...
      try {
        for (int i = 1; i <= columnNumber; i++) {
          ...
          entityMeters.addTypeTime(type, System.currentTimeMillis() - start);
        }
      } catch (Exception e) {
        if (IS_DEBUG) {
